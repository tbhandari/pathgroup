...
$('#elana_lnk').on('click', function() {
    ...
    $('#elana_content').show();
    $('#home_content, #smitha_content, #patient_content, #forms_content, #contact_content, #rxrefill_content').hide();
...
$('#resources_lnk, #resources_lnk_footer').on('click', function() {
    ...
    $('#home_content, #smitha_content, #elana_content, #forms_content, #contact_content, #rxrefill_content').hide();
...
$('#forms_lnk, #forms_lnk_footer').on('click', function() {
    setLogoInfoText();
    $('#forms_content').show();
    $('#home_content, #smitha_content, #elana_content, #patient_content, #contact_content, #rxrefill_content').hide();
...
$('#contact_lnk, #contact_lnk_footer').on('click', function() {
    ...
    $('#home_content, #smitha_content, #elana_content, #patient_content, #forms_content, #rxrefill_content').hide();
    ga('send', 'event', 'contact_lnk', 'click', 'nav_links');
});

$('#rxrefill_lnk, #rxrefill_lnk_footer').on('click', function() {
    setLogoInfoText();
    $('#rxrefill_content').show();
    $('#home_content, #smitha_content, #elana_content, #patient_content, #forms_content, #contact_content').hide();
...
function initialize() {
    ...
    $('#home_content').show();
    $('#smitha_content, #elana_content, #patient_content, #forms_content, #contact_content, #rxrefill_content').hide();
}
...
function loadSBInfo() {
    ...
    $('#smitha_content').show();
    $('#home_content, #elana_content, #patient_content, #forms_content, #contact_content, #rxrefill_content').hide();
